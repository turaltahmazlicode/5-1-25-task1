...
namespace _5_1_25_task1.MVC.Areas.Admin.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Id")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,Id")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
